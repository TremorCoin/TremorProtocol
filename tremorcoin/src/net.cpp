...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Tremorcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"tremorcoin.com", "dnsseed.tremorcoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Tremorcoin is probably already running."), addrBind.ToString().c_str());
        else
